...
claude plugin search @ai-maestro
...
claude plugin install perfect-skill-suggester@ai-maestro:1.2.0
```
...
claude plugin marketplace list | grep ai-maestro
...
```bash
# Search for plugin
claude plugin search perfect-skill-suggester@ai-maestro
