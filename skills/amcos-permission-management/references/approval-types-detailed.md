...
- [1. Agent Spawn Approval](#1-agent-spawn-approval)
  ...
  - [1.3 AMAMA Decision Options for Spawn](#13-amama-decision-options-for-spawn)
- [2. Agent Terminate Approval](#2-agent-terminate-approval)
  ...
  - [2.3 AMAMA Decision Options for Terminate](#23-amama-decision-options-for-terminate)
- [3. Agent Hibernate Approval](#3-agent-hibernate-approval)
  ...
  - [3.3 AMAMA Decision Options for Hibernate](#33-amama-decision-options-for-hibernate)
- [4. Agent Wake Approval](#4-agent-wake-approval)
  ...
  - [4.3 AMAMA Decision Options for Wake](#43-amama-decision-options-for-wake)
- [5. Plugin Install Approval](#5-plugin-install-approval)
  ...
  - [5.3 AMAMA Decision Options for Plugin Install](#53-amama-decision-options-for-plugin-install)
...
### 1.3 AMAMA Decision Options for Spawn

AMAMA can respond with:
...
### 2.3 AMAMA Decision Options for Terminate
...
### 3.3 AMAMA Decision Options for Hibernate
...
### 4.3 AMAMA Decision Options for Wake
...
### 5.3 AMAMA Decision Options for Plugin Install
