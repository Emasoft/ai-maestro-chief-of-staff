...
- 1.3 Pre-operation notification procedure - Step-by-step process
  ...
  - 1.3.3 Send notification - Using the `ai-maestro-plugin:agent-messaging` skill
...
**Purpose:** Deliver the notification using the `ai-maestro-plugin:agent-messaging` skill.
