...
parent-skill: amcos-post-op-notification
---
...
1. Send via the `amp-send` CLI a final notice (see Example 2)
...
- [ ] Sent notification with high priority via the `amp-send` CLI
