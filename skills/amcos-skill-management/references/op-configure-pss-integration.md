...
- Include tool names: "AI Maestro", "`ai-maestro-plugin:agent-messaging` skill"
...
If you also need to:
- Manage plugins -> See amcos-plugin-management skill
- Onboard agents -> See amcos-onboarding skill
```
...
echo "Expected: amcos-skill-management"
