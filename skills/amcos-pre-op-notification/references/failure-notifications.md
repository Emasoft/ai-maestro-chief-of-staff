...
- 4.3 Failure notification procedure - Step-by-step process
  ...
  - 4.3.3 Send notification - Using the `ai-maestro-plugin:agent-messaging` skill
...
**Purpose:** Deliver the failure notification using the `ai-maestro-plugin:agent-messaging` skill.
