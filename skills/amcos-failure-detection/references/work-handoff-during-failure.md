...
via the `amp-send` CLI: `amp-send <recipient> "<subject>" "<message>" [--type T] [--priority P]`, send the handoff request:
...
via the `amp-send` CLI, send notification:
...
via the `amp-send` CLI, request reassignment:
- **Recipient**: `amoa-orchestrator`
...
via the `amp-send` CLI, notify the orchestrator:
- **Recipient**: `amoa-orchestrator`
...
via the `amp-send` CLI, request a task split:
- **Recipient**: `amoa-orchestrator`
...
via the `amp-send` CLI, request AMOA to coordinate emergency handoff:
- **Recipient**: `amoa-orchestrator`
...
via the `amp-send` CLI, notify the receiving agent:
...
via the `amp-send` CLI, send detailed instructions:
- **Recipient**: the receiving agent session name
...
via the `amp-send` CLI, request reconciliation:
- **Recipient**: `amoa-orchestrator`
...
via the `amp-send` CLI, request update:
- **Recipient**: `amoa-orchestrator`
...
via the `amp-send` CLI, report resolution:
- **Recipient**: `amama-assistant-manager`
...
via the `amp-send` CLI, send the complete emergency handoff message:
