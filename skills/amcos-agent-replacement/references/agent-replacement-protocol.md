...
Create an artifact inventory at `$AGENT_DIR/db/agent-health/artifacts-AGENT_NAME.md` documenting the git state, preserved logs, and lost artifacts.
...
- [ ] Replacement request sent to AMAMA via `agent-messaging` skill
