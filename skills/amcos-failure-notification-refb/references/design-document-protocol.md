...
```bash
uv run python scripts/amcos_design_search.py --uuid REQ-20260129-0001
```

### 5.2 Search by Type

```bash
uv run python scripts/amcos_design_search.py --type requirement
uv run python scripts/amcos_design_search.py --type handoff
```

### 5.3 Search by Status

```bash
uv run python scripts/amcos_design_search.py --status APPROVED
uv run python scripts/amcos_design_search.py --status IMPLEMENTING
```

### 5.4 Search by Keyword

```bash
uv run python scripts/amcos_design_search.py --keyword "authentication"
```

### 5.5 Combined Search

```bash
uv run python scripts/amcos_design_search.py --type requirement --status DRAFT --keyword "API"
```
...
```python
from amcos_design_create import create_design_document
...
```python
from amcos_design_search import search_documents
