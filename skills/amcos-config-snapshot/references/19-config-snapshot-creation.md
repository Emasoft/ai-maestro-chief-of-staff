...
This file is SEPARATE from authoritative configs in `design/config/` (OPTIONAL: If EOA (AI Maestro Orchestrator Agent) plugin is installed). It's a **read-only capture** for comparison purposes.
