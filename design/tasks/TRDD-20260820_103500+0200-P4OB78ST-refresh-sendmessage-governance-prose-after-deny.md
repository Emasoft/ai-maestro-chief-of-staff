...
updated: 2026-08-20T10:35:00+0200
...
- [ ] Every "nothing refuses you"-shaped claim about the client SendMessage tool is
      updated to reflect the structural deny, without weakening the R6 warnings.
- [ ] No new teach-to-use instruction introduced; amp-* CLIs remain the only taught path.
- [ ] Suite green, ruff clean, trddgrep validate exit 0; ships with the next release.
