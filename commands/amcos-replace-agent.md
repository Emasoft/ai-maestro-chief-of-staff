...
│                                                             │
│  3. GENERATE HANDOFF                                        │
│     └─> Request AMOA (Orchestrator) to create handoff docs   │
│     └─> Include: task state, context, pending work          │
│                                                             │
│  4. UPDATE KANBAN                                           │
│     └─> Request AMOA to update GitHub Project board          │
...
**Verify**: AMOA responds with handoff document location.
...
**Verify**: AMOA confirms cards have been reassigned.
...
| "Handoff generation failed" | AMOA error | Check AMOA status, retry |
